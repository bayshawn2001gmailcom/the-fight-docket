...
<!-- EDITOR'S NOTE -->
    <div style="background-color:#0D0D0D; padding:40px 40px 8px 40px;">
      ...
      <img width="600" src="https://i.ibb.co/yBhpPRYJ/nb2-2026-08-17-intro-web.jpg" alt="intro" style="width:100%; max-width:600px; display:block; margin:0 0 28px 0; border:1px solid #1E1E1E;">
...
<!-- MAIN STORY -->
    <div style="background-color:#0D0D0D; padding:8px 40px;">
      ...
      <div style="width:40px; height:3px; background:#DE1E20; margin-bottom:22px;"></div>
      <img width="600" src="https://i.ibb.co/67s2FFpQ/nb2-2026-08-17-main-story-web.jpg" alt="main_story" style="width:100%; max-width:600px; display:block; margin:0 0 28px 0; border:1px solid #1E1E1E;">
...
<!-- LEGAL TRACKER -->
    <div style="background-color:#0D0D0D; padding:8px 40px;">
      ...
      <div style="width:40px; height:3px; background:#DE1E20; margin-bottom:22px;"></div>
      <img width="600" src="https://i.ibb.co/KjV3TkJt/nb2-2026-08-17-legal-web.jpg" alt="legal" style="width:100%; max-width:600px; display:block; margin:0 0 28px 0; border:1px solid #1E1E1E;">
...
<!-- RUMOR MILL -->
    <div style="background-color:#0D0D0D; padding:8px 40px;">
      ...
      <div style="width:40px; height:3px; background:#DE1E20; margin-bottom:22px;"></div>
      <img width="600" src="https://i.ibb.co/xK1xbJLk/nb2-2026-08-17-rumor-web.jpg" alt="rumor" style="width:100%; max-width:600px; display:block; margin:0 0 28px 0; border:1px solid #1E1E1E;">
<div style='border-left:3px solid #C5A059; padding:4px 0 4px 18px; margin-bottom:28px;'>
        ...
        <p style='margin:0; color:#F2F2E8; line-height:1.8;'>New IBF middleweight champion Aaron McKenna wants Hamzah Sheeraz next, and he has been saying so publicly for months. The complication is weight: McKenna has called for the fight at super middleweight, which would mean vacating or risking the belt he just won in Dublin. McKenna fights under the Zuffa Boxing banner, so TKO controls whether this gets made rather than any of boxing's traditional promoters, and TKO has shown it likes marquee names on its cards. Timing is the open question, not appetite.</p>
...
<!-- FIGHT CARD PREVIEWS -->
    <div style="background-color:#0D0D0D; padding:8px 40px;">
      ...
      <div style="width:40px; height:3px; background:#DE1E20; margin-bottom:22px;"></div>
      <img width="600" src="https://i.ibb.co/zWBf79X9/nb2-2026-08-17-fight-previews-web.jpg" alt="fight_previews" style="width:100%; max-width:600px; display:block; margin:0 0 28px 0; border:1px solid #1E1E1E;">
...
<!-- BUSINESS INTEL -->
    <div style="background-color:#0D0D0D; padding:8px 40px;">
      ...
      <div style="width:40px; height:3px; background:#DE1E20; margin-bottom:22px;"></div>
      <img width="600" src="https://i.ibb.co/5gQ09Z5y/nb2-2026-08-17-business-intel-web.jpg" alt="business_intel" style="width:100%; max-width:600px; display:block; margin:0 0 28px 0; border:1px solid #1E1E1E;">
...
<!-- FIGHTER SPOTLIGHT -->
    <div style="background-color:#0D0D0D; padding:8px 40px;">
      ...
      <div style="width:40px; height:3px; background:#DE1E20; margin-bottom:22px;"></div>
      <img width="600" src="https://i.ibb.co/TD5kCBNs/nb2-2026-08-17-fighter-spotlight-web.jpg" alt="fighter_spotlight" style="width:100%; max-width:600px; display:block; margin:0 0 28px 0; border:1px solid #1E1E1E;">
