...
- Newsletter: newsletter_april_20_2026.html
- Tweets posted: 6
- Thread root: https://x.com/thefightdocket/status/2066907133006995663

  T1: The UFC's $7.7 BILLION Paramount deal was meant to elevate everyone. Instead, it...
  T2: Dana White's 'looking good' on McGregor? Insider sources confirm active talks, b...
  T3: The UFC's $7.7B Paramount/CBS deal promised a rising tide. For many, it's a drou...
  T4: UFC 328 presents Khamzat Chimaev's 1st title defense vs. Sean Strickland – a rel...
  T5: UFC 329 (July 11, IFW) is under immense pressure. It's the UFC's signature event...
  T6: Understanding these market dynamics is critical. Join thousands of combat sports...

- Status: ✅ Posted
## 2026-04-20 — Automated Social Run
- Twitter/X: ✅ POSTED — 6-tweet thread from @thefightdocket (newsletter_april_20_2026.html). Hook: Gilbert Burns retirement / McGregor "looking good" / Chimaev + RAF / Le v. Zuffa $237M payout / UFC 328 preview / CTA → thefightdocket.com
- Reddit: ❌ FAILED — Reddit blocked by browser safety restrictions (consistent with 2026-04-06 run). No reddit-posts file exists for April 20; April 6 file not used (stale content). Manual posting required.
- Instagram: ❌ SKIPPED — Session active but logged in as @atlantaturfdoctor (wrong account). No instagram-caption file exists for April 20. Action needed: log into @thefightdocket on Instagram.

---

## 2026-04-06 — Instagram Post
- Headline: $1 billion. Two lawsuits. TKO facing the same number in boxing court as it has championship belts.
- Canva card: Updated and exported from template DAHFUgzop8k (Instagram Card — April 6, 2026)
- Stats on card: Queensberry vs. TKO Damages ($1B) | TKO Boxing Lawsuits Active (2) | PFL ESPN Deal Expires (2026) | UFC vs. DC Commission (ZERO)
- Caption saved to: instagram-caption-2026-04-06.txt
- Image saved to: fight-docket-instagram-2026-04-06.png (Downloads folder)
- Status: ⚠️ Action needed — Instagram session not active in Chrome. Log in at instagram.com/@thefightdocket, upload the card PNG, and paste caption from instagram-caption-2026-04-06.txt

---

## 2026-04-06 — Reddit Posts
- r/MMA: **Failed** — Reddit blocked by browser safety restrictions. Post ready in `reddit-posts-2026-04-06.md`
  - Title: "The UFC held a fight card on White House grounds specifically to dodge DC Athletic Commission oversight. Here's why that matters."
- r/Boxing: **Failed** — Reddit blocked by browser safety restrictions. Post ready in `reddit-posts-2026-04-06.md`
  - Title: "Frank Warren just sued TKO and Saudi Arabia's Sela for $1 billion. The contract theory is actually pretty specific — and hard to dismiss."
- r/SportsLaw: **Failed** — Reddit blocked by browser safety restrictions. Post ready in `reddit-posts-2026-04-06.md`
  - Title: "Queensberry v. TKO: $1B breach of contract claim over Zuffa Boxing's formation — the contract theory, the damages math, and why this one is harder to dismiss than it looks."
- **Action needed:** Posts are written and saved. Manual posting required at reddit.com/u/TheFightDocket.

---

## 2026-04-06 Twitter Thread
- Headline: TKO Group Holdings now faces TWO separate $1 billion boxing lawsuits. Frank Warren's Queensberry just filed. The combat sports empire is under siege. 🧵
- Canva card: Updated and exported from template DAHFUjfjJwk — headline, stats, and date updated for April 6, 2026 issue
- Canva card note: PNG exported (475KB) — image attachment via browser automation not completed (X.com CSP blocked cross-origin fetch; upload_image tool unavailable in this session). Canva card available at: https://www.canva.com/d/0I6brXGxDRIRQXG
- Account: @pgjarvispl
- Tweets posted: 6
- Thread content:
  - T1 (hook): "TKO Group Holdings now faces TWO separate $1 billion boxing lawsuits. Frank Warren's Queensberry just filed. The combat sports empire is under siege. 🧵"
  - T2 (Main Event): "Queensberry filed Feb 25 against TKO and Saudi Sela, seeking $1B in lost income. The claim: TKO used Queensberry's exclusive Sela contract and data infrastructure to build Zuffa Boxing, then cut Warren out entirely. This is the $1B blueprint theft argument."
  - T3 (Undercard 1): "Meanwhile, Frank Warren is also fighting Matchroom for UK talent, Sky Sports slots, and arena dates. Who wins Britain's boxing arms race will shape the biggest transatlantic fights of 2027-2028."
  - T4 (Undercard 2): "UFC held a card on White House grounds, outside DC Athletic Commission jurisdiction. No DC-licensed physicians. No mandatory medical protocols. If this becomes a template, state oversight of combat sports just got a new loophole."
  - T5 (Undercard 3): "PFL has cleared a significant portion of its outstanding debt, fueled by Saudi-linked investment. A debt-free PFL is a very different negotiating partner as ESPN, DAZN and Amazon eye MMA rights ahead of 2027. Their ESPN deal expires this year."
  - T6 (CTA): "Full breakdown + data table: thefightdocket.com/p/queensberry-files-tko-faces-second-1-billion-boxing-lawsuit | Subscribe free: thefightdocket.com #FightBusiness"
- Status: ✅ Posted (thread confirmed live on profile)
- Action needed: Manually attach Canva card PNG to tweet 1 — open https://www.canva.com/d/0I6brXGxDRIRQXG, export page 1 as PNG, and add as image to the thread's first tweet

---

## 2026-03-30 Twitter Thread

- **Headline:** Top Rank just dropped from $85M/yr (ESPN) to $10M/yr (DAZN) — Ali Act passes House with TKO as biggest backer
- **Newsletter issue:** March 31, 2026
- **Canva card:** Exported from template DAHFUjfjJwk (lXesz8jKcBFRnVe shortlink)
- **Account posted from:** @pgjarvispl
- **Tweets posted:** 6
- **Thread root:** https://x.com/pgjarvispl/status/2038713932966162874
- **Tweet IDs:**
  - T1 (hook + Canva card): 2038713932966162874
  - T2 (Ali Act / TKO conflict): 2038714836947796042
  - T3 (Top Rank math): 2038715330315342215
  - T4 (Dana White / litigation): 2040006646559055944
  - T5 (sanctioning bodies / Crawford): 2040007257824370830
  - T6 (CTA): posted as reply to T5
- **Status:** ✅ Posted
